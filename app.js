...
async function subirArchivo() {
    ...
    try {
        ...
        if (respuesta.ok) {
            ...
            statusDiv.innerText = resultado.mensaje || 'Error al subir.';
        }
    } catch (error) {
...
async function cargarArchivos() {
    ...
    try {
        ...
        archivos.forEach(a => {
            ...
            li.innerHTML = `
                📁 <a href="${URL_API.replace('/api', '')}/uploads/${a.nombre}" target="_blank">${a.nombre}</a>
                <div style="margin-left: auto;">
                    <button onclick="renombrarArchivo(${a.id}, '${a.nombre}')">✏️</button>
        ...
        lista.innerHTML = '<li style="color: red;">Error al conectar.</li>';
    }
}
